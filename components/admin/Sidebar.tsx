...
export function Sidebar({ isOpen = false, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-gray-100 hidden lg:flex flex-col">
        {/* Logo */}
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 h-screen w-64 bg-white border-r border-gray-100 flex flex-col lg:hidden transition-transform duration-300 ease-in-out",
